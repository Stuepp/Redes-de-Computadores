...
class Server:
    ...
    def send(self, msg):
        msg = '{};health:{};score:{}'.format(msg, self.health, self.score)
    ...
    def handle_monster_attack(self):
        ...
        self.send('MONSTER_ATTACK;{} \n guess a number from 0 or 2 to 5'.format(doors_number))
    ...
    def handle_chest(self):
        ...
        message = "TAKE_CHEST\nTo take chest write: YES, if u dont want it just do something else"
        self.send(message)
        response = str(self.receive(), 'utf-8') # dá para fazer aceitar maiscula e minuscula
        if response == 'YES':
    ...
    def handle_boss(self):
        ...
        message = "BOSS_EVENT\nPossible actions FIGHT or try to ESCAPE"
        self.send(message)
    ...
    def start_play(self):
        try:
            ...
            while True:
                event = choice(POSSIBLE_EVENTS) #5/11 monster 4/11 nothin 1/11 chest or boss
